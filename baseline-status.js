...
const ICONS = {
  ...
  >
    <g clip-path="url(#a)">
      <path
        fill="#fff"
        d="M10.2 15.3a5.1 5.1 0 1 0 0-10.2 5.1 5.1 0 0 0 0 10.2Z"
      />
      <path
        fill="#229342"
        d="M5.783 12.75 1.367 5.103A10.198 10.198 0 0 0 10.201 20.4l4.416-7.65a5.098 5.098 0 0 1-8.834.001Z"
      />
      <path
        fill="#FBC116"
        d="M14.617 12.75 10.2 20.4a10.199 10.199 0 0 0 8.831-15.3H10.2a5.1 5.1 0 0 1 4.418 7.65Z"
      />
      <path
        fill="#229342"
        d="M10.2 14.238a4.038 4.038 0 1 0 0-8.075 4.038 4.038 0 0 0 0 8.075Z"
      />
      <path
        fill="#E33B2E"
        d="M10.2 5.1h8.833a10.198 10.198 0 0 0-17.666.002l4.416 7.649h.002a5.1 5.1 0 0 1 4.415-7.65Z"
      />
    </g>
    <defs>
      <clipPath id="a"><path fill="#fff" d="M0 0h20.4v20.4H0z" /></clipPath>
    </defs>
  </svg>`,
  edge: html`<svg
    xmlns="http://www.w3.org/2000/svg"
  ...
  >
    ...
    <defs>
      <radialGradient
        ...
        cy="0"
        r="1"
        gradientTransform="matrix(7.60219 0 0 7.22208 12.527 14.212)"
  ...
  >
    ...
    <defs>
      ...
      <clipPath id="M"><path fill="#fff" d="M0 0h20.4v20.4H0z" /></clipPath>
      <path
        id="N"
  ...
  >
    <g clip-path="url(#D)">
      <path
        opacity=".53"
        d="M19.505 10.524a8.76 8.76 0 0 1-.708 3.447c-.468 1.093-1.153 2.086-2.017 2.922a9.33 9.33 0 0 1-3.018 1.953 9.57 9.57 0 0 1-7.121 0 9.33 9.33 0 0 1-3.018-1.953c-.864-.836-1.549-1.83-2.017-2.922a8.76 8.76 0 0 1-.708-3.447c0-2.389.98-4.68 2.725-6.37s4.111-2.638 6.579-2.638a9.57 9.57 0 0 1 3.56.686 9.33 9.33 0 0 1 3.018 1.953c.864.837 1.549 1.83 2.017 2.923a8.76 8.76 0 0 1 .708 3.447z"
        fill="#000"
      />
      <path
        d="M19.859 9.729c0 1.275-.25 2.538-.735 3.716s-1.197 2.249-2.094 3.151-1.962 1.617-3.133 2.105a9.61 9.61 0 0 1-3.696.739 9.63 9.63 0 0 1-6.829-2.844 9.74 9.74 0 0 1 0-13.734A9.63 9.63 0 0 1 10.201.018a9.61 9.61 0 0 1 3.696.739c1.172.488 2.236 1.203 3.133 2.105s1.608 1.972 2.094 3.151.735 2.441.735 3.716z"
        fill="url(#B)"
        stroke="#cdcdcd"
        stroke-width=".352"
    ...
    <defs>
      ...
      <radialGradient
        ...
        r="1"
        gradientUnits="userSpaceOnUse"
        gradientTransform="translate(10.2407 8.42366) scale(9.65803 9.71116)"
      >
      ...
      <clipPath id="D"><path fill="#fff" d="M0 0h20.4v20.4H0z" /></clipPath>
    </defs>
  </svg>`,
};
